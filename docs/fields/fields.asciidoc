...
| <<ecs-cisco_duo,cisco_duo>> | Fields for Cisco Duo logs
...
| <<ecs-hashicorp_vault,Hashicrop Vault Audit Logs>> | Hashicrop Vault Audit Logs
...
| <<ecs-winlog,Windows Event Logs>> | winlog
