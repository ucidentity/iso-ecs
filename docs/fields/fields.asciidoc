...
| <<ecs-hashicorp_vault,hashicorp vault audit logs>> | hashicorp vault audit logs
...
| <<ecs-journald,journald>> | journald
...
| <<ecs-nat_allocation,nat_allocation>> | nat_allocation
...
| <<ecs-user,user fields>> | Fields to describe the user relevant to the event.
